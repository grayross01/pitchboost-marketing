...
export const INDUSTRIES: Industry[] = [
...

  {
    ...
    metaDescription:
      "PitchBoost helps B2B sales teams generate personalized sales pitch decks for every prospect in a couple of minutes. Stop sending the same deck to every deal — win more with decks built around each buyer's specific pain points.",
    ...
    outcomes: [
      "Personalized sales pitch deck for every prospect in a couple of minutes",
...

  {
    ...
    metaDescription:
      "PitchBoost helps SaaS and technology companies generate tailored enterprise pitch decks for every buyer persona in a couple of minutes. Turn your platform's capabilities into a deck that speaks directly to each prospect's specific pain points.",
    heroHeadline: "SaaS pitch decks tailored to every enterprise buyer's situation",
    heroSubhead:
      "Enterprise buyers don't want a product overview — they want to see how your platform solves their specific problem. PitchBoost builds a tailored SaaS pitch deck for every prospect, from your product capabilities, in a couple of minutes.",
    sampleDeckUrl: "https://app.pitchboost.ai/p/sample/klaviyo-us-dollarshaveclub-com",
    painPoints: [
      {
...

  {
    ...
    metaDescription:
      "PitchBoost helps startups generate polished pitch decks for sales, partnerships, and investor meetings in a couple of minutes. Look professional and move fast — without a design team, an agency, or hours spent on slides.",
    heroHeadline: "Startup pitch decks that look enterprise-grade without the enterprise budget",
    heroSubhead:
      "Startups pitch investors, customers, and partners simultaneously — often with the same founder doing all three. PitchBoost generates a polished, branded pitch deck for any audience in a couple of minutes, so you spend time building the company, not building slides.",
    ...
    painPoints: [
      ...
      },
      {
        ...
        body: "Agencies charge $5,000–$15,000 for a pitch deck. Freelancers take two weeks. You need to pitch next Thursday. PitchBoost builds a professional, branded deck in a couple of minutes.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "PitchBoost Pro is $29/month. Design agencies typically charge $5,000–$15,000 per deck. Freelancers charge $500–$2,000 and take days. PitchBoost generates a professional, branded deck in a couple of minutes and lets you update it as your startup evolves.",
      },
      {
...

  {
    ...
    metaDescription:
      "PitchBoost helps media companies, event organizers, podcasters, and content creators generate compelling sponsorship pitch decks and media kits in a couple of minutes. Package your audience and close more sponsorship deals with materials that actually convert.",
    ...
    outcomes: [
      "Tailored sponsorship deck for every brand in a couple of minutes",
...

  {
    ...
    metaDescription:
      "PitchBoost helps marketing agencies, creative studios, and PR firms generate tailored pitch decks for every prospective client in a couple of minutes. Upload your credentials once, win more clients with decks built around their business.",
    heroHeadline: "Agency pitch decks that win clients, built in 60 seconds",
    heroSubhead:
      "Stop sending credentials decks that weren't built for the room. PitchBoost generates a tailored pitch deck for every prospective client — from your agency credentials, mapped to their specific brief — in a couple of minutes.",
    painPoints: [
      {
    ...
    outcomes: [
      ...
      "Every client deck looks bespoke — generated in a couple of minutes",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes — PitchBoost is built for this exact problem. You upload your agency's credentials, case studies, and capabilities once. For each new business pitch, you describe the prospective client and their brief. PitchBoost generates a tailored agency credentials deck in a couple of minutes that's built around their industry and objectives — not a generic agency pitch deck template with the last client's logo swapped out.",
      },
      {
...

  {
    ...
    metaDescription:
      "PitchBoost helps consultancies and professional services firms generate tailored proposals and pitch decks for every prospective client in a couple of minutes. Demonstrate expertise before the first meeting with decks built around each client's specific situation.",
...

  {
    ...
    metaDescription:
      "PitchBoost helps recruiting agencies and staffing firms generate tailored pitch decks for every prospective client company in a couple of minutes. Win more preferred vendor agreements and retained searches with decks built around each hiring team's specific talent needs.",
...

  {
    ...
    metaDescription:
      "PitchBoost helps executive coaches, corporate trainers, and professional speakers generate tailored proposals for every corporate client in a couple of minutes. Win more programs, engagements, and retainers with materials that prove your expertise before the first meeting.",
    ...
    outcomes: [
      ...
      "Proposals tailored to each client's team challenges in a couple of minutes",
    ...
    faqs: [
      {
        ...
        a: "Yes. Whether you need a speaking proposal for a conference organizer, a one-sheet for a speaker bureau, or a training program proposal for a corporate L&D team, PitchBoost generates the right format from your credentials in a couple of minutes.",
      },
      {
...

  {
    ...
    outcomes: [
      ...
      "Professional contractor proposals created in a couple of minutes",
...

  {
    ...
    metaDescription:
      "PitchBoost helps commercial real estate brokers and investors generate polished property overview decks, lease proposals, and investment memos in a couple of minutes. Look like a top-10 brokerage on every deal — no matter your firm's size.",
    ...
    outcomes: [
      "Professional property decks and investment memos in a couple of minutes",
...

  {
    ...
    metaDescription:
      "PitchBoost helps real estate agents build a polished listing presentation for every appointment in a couple of minutes. Paste a Zillow or Redfin link to autofill the home, walk in with a deck tailored to the seller, and see the moment they open it. Win more listings without rebuilding your slides every weekend.",
    heroHeadline: "Win the listing before you walk in the door",
    heroSubhead:
      "Sellers interview two or three agents before they sign, and your listing presentation is the one thing they keep, forward to their spouse, and compare side by side. PitchBoost builds a polished, tailored presentation for every appointment: the pricing story, the marketing plan, and your track record, formatted to the home and the seller, in a couple of minutes.",
    painPoints: [
      {
    ...
    outcomes: [
      "A tailored listing presentation for every appointment in a couple of minutes",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes, that is exactly what PitchBoost is. You set up your agent brand and track record once. For each appointment you paste the property link or describe the home and the seller, and PitchBoost generates a tailored listing presentation in a couple of minutes, with no template to rebuild for every seller.",
      },
      {
...

  {
    ...
    metaDescription:
      "PitchBoost helps financial advisors, RIAs, and wealth management firms generate polished prospect presentations and client materials in a couple of minutes. Convert more prospective clients and circulate professional materials across every organization you serve.",
    ...
    outcomes: [
      "Tailored prospect presentation for every prospective client in a couple of minutes",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes — PitchBoost is built for this. You upload your firm's investment philosophy, team credentials, AUM profile, and service model once. For each prospect, you describe their financial situation and goals. PitchBoost generates a tailored financial advisor presentation in a couple of minutes — no financial advisor pitch deck template to manually customize for every prospect meeting.",
      },
      {
...

  {
    ...
    metaDescription:
      "PitchBoost helps nonprofits generate compelling pitch decks for donors, grant applications, and corporate partnerships in a couple of minutes. Tell your mission's story with materials that look as good as the work you do.",
    ...
    outcomes: [
      "Compelling donor and grant pitch decks in a couple of minutes",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes — PitchBoost is built for exactly this. You upload your organization's mission, programs, impact data, and financials once. For each funder, donor, or corporate partner, you describe their giving priorities. PitchBoost generates a tailored nonprofit pitch deck in a couple of minutes — no nonprofit presentation template to manually adapt for every grant application or donor meeting.",
      },
      {
