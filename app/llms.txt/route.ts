...
export function GET() {
  const out: string[] = [
    "# PitchBoost",
    "",
    "> AI pitch deck and sales presentation builder. PitchBoost generates a personalized, on-brand deck for a specific prospect or deal in a couple of minutes, publishes it as a trackable link with its own deal room, and shows you exactly who opened it and what they read.",
    "",
