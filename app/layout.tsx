...
const organizationSchema = {
  ...
  description: "AI-powered pitch deck builder for sales teams, agencies, and anyone who pitches. Generate personalized, branded presentations in a few minutes.",
  sameAs: [
