...
export default async function SharedTimelinePage({
  ...
  return (
    <div style={{ maxWidth: 640, margin: "0 auto", padding: "48px 20px 60px" }}>
      <div style={{ background: "#fff", border: "1px solid #e5e9ef", borderRadius: 16, padding: "30px 28px", boxShadow: "0 1px 3px rgba(16,34,44,0.05)" }}>
          ...
          return (
            <div key={i} style={{ display: "flex", gap: 14, position: "relative", paddingBottom: i === sorted.length - 1 ? 0 : 20 }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 14 }}>
                <span style={{ width: 12, height: 12, borderRadius: "50%", background: past ? "#c6ced8" : "var(--ds-primary, #0e5a64)", marginTop: 5, flexShrink: 0 }} />
